...
To compute the population-weighted GDP Gini coefficient for each Europ\<ean NUTS 2 level region within the subset of countries, we used the formula below:
