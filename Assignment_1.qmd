...
scatter_plot <- ggplot(subset_nuts2data, aes(x = seq(1:80), y = pop, color = id_nuts2)) +
  geom_point() +
  labs(x = "NUTS2 Region", y = "Population")
...
```{r}
# Create the scatterplot
scatter_plot <- ggplot(subset_nuts2data_UK, aes(x = seq(1:41), y = pop, color = id_nuts2)) +
  geom_point() +
  labs(x = "NUTS2 Region", y = "Population")
plot_grid(scatter_plot)
```
