...
2.  *SLR:* **Sample Variation:** *There is variation in X.*
    ...
    This assumption is met as we have variation in our variables.\
...
With the population-weighted GDP Gini coefficient ($GINIW_j$) as the dependent variable and the GDP per capita ($y_j$ ) ++\[determinants\]++ as the independent variables.

NB!
Vi må skille determinantene (X_2010) i modellen under på en eller annen måte:
