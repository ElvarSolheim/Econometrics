...
We extracted a subset of data, referred to as "subset_nuts2data," from our main dataset "main_data_nuts2." This subset specifically pertains to the year 2018, a period preceding the COVID-19 pandemic and its associated economic repercussions.
...
Within this subset, we focused on NUTS2 regions in four countries: Czechia, Turkey, the United Kingdom (UK), and Finland.
Our aim was to explore potential trends in income inequality, as measured by the Gini coefficient, in relation to the population of these NUTS2 regions.
...
To create these visualizations, we utilized the versatile ggplot2 library in R, enabling us to analyze and depict the data effectively.
