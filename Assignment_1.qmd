...
main_data_2 <- main_data_2 %>%
   select(year, id_nuts0, -geo, id_nuts3, pop_n3 = pop, gdp_n3 = gdp, gdp_per_capita_n3 = gdp_per_capita, id_nuts2, pop_n2, gdp_n2, gdp_per_capita_n2, gdp_per_capita_n2, gini_n2 )
```
