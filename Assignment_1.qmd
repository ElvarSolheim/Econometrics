...
We estimate the regression model by using a subset containing only observations from the year 2010 for all the nuts 2 regions.
...
According to @lessmann2017 the relationship between regional development and regional inequality follow a pattern similar to a N-shape.
By examinating changes in inequality over time, they found that the majority of all countries experience sigma convergence, which means that regional inequality decreases over time.
However, some poor and lower-middle-income countries, along with some rich economies, show divergence.
Very poor countries exhibit increasing inequalities, while most middle- and high-income countries show decreasing or stabilizing inequalities.
It is also noted that regional inequalities increase again in the richest countries.
