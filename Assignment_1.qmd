...
We have already tested the development effects with one estimate for all countries, another for the UK and a seperate estimate for the EU countries.
Now, we will take a closer look at the EU countries.
This subset analysis includes three subsets, each corresponding to one of our EU countries.
...
We will now estimate one logarithmic model for the EU countries and one quadratic model for the UK.
